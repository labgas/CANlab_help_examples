...
atlasname_glm = 'canlab2024_fine_2mm';                                  % default use of new canlab2024 atlas - leaving blank will use legacy canlab2018 atlas, which is not recommended anymore
                                                                            ...
                                                                            % 2. labeling regions in both voxelwise and parcelwise analyses
                                                                                ...
                                                                                %           canlab_2018 (used if you do not specify this option)
...
dobootstrap_svm = false;                                                        % default false                         only use true for final analysis, since this takes a lot of time, especially if boot_n is set to the default 5k samples
    boot_n_svm = 5000;                                                              % default 5000                          number of bootstrap samples, reduce number for quick results
...
dostabilityselection_svm = false;                                                % default false                        only use true for final analysis, since this may take a lot of time
   boot_n_ss_svm = 500;                                                             % default 500                           should be enough for determining top weights % across bootstrap samples
   cons2ss_svm = [];                                                                % default empty                         stability selection on all contrasts in DAT.contrasts; specify contrast indices if you want to restrict to a subset
   k_ss_svm = 2000;                                                                 % default 2000                          top-k voxels by |w| per bootstrap
   threshold_ss_svm = 0.6;                                                          % default 0.6                           "stable" if selected in >= x% of boots
