...
%       <proj>_secondlevel_m<M>_s<N>_c2g_run_multivariate_mediation_single_trial
%
% Or, interactively from the Matlab terminal (use this when you want
% higher-resolution figures, or are debugging):
%
%   LaBGAScore_prov_publish('c2g_run_multivariate_mediation_single_trial', htmlsavedir)
%
