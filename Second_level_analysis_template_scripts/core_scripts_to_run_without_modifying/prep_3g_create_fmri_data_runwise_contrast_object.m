...
%       <proj>_secondlevel_m<M>_s<N>_prep_3g_create_fmri_data_runwise_contrast_object
%
% Or, interactively from the Matlab terminal (use this when you want
% higher-resolution figures, or are debugging):
%
%   LaBGAScore_prov_publish('prep_3g_create_fmri_data_runwise_contrast_object', htmlsavedir)
%
