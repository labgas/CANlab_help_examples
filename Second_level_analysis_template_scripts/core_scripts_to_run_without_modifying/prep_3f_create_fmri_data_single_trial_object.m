...
%       <proj>_secondlevel_m<M>_s<N>_prep_3f_create_fmri_data_single_trial_object
%
% Or, interactively from the Matlab terminal (use this when you want
% higher-resolution figures, or are debugging):
%
%   LaBGAScore_prov_publish('prep_3f_create_fmri_data_single_trial_object', htmlsavedir)
%
