...
%       <proj>_secondlevel_m<M>_s<N>_c2_SVM_contrasts_masked
%
% Or, interactively from the Matlab terminal (use this when you want
% higher-resolution figures, or are debugging):
%
%   LaBGAScore_prov_publish('c2_SVM_contrasts_masked', htmlsavedir)
%
...
%
% * save_figures_svm            true saves .svg files of all figures generated by c2a_second_level_regression.m (slow, takes up space)
%
...
%
% _Options to copy if specified in prep_3c script_
%
...
% -------------------------------------------------------------------------
%
% c2_SVM_contrasts_masked.m         v8.1
%
...
for c = 1:kc
    ...
    %%
    % *ROC PLOT AND THRESHOLDED SVM MAPS IF BOOTSTRAPPED*
