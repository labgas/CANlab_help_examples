...
%   Two options
%       # atlas name from load_atlas.m for different atlas than
%           default canlab_2018 (used if you do not specify this option)
%       # which('xxx.mat') name of .mat file in maskdir, generated by
...
%
% -------------------------------------------------------------------------
% @(#)% prep_3a_run_second_level_regression_and_save.m         v5.2
...
% <H2>OPTIONS IF DESIGN_MATRIX_TYPE = CUSTOM</H2>
...
% <H2>OPTIONS IF DESIGN_MATRIX_TYPE = GROUP</H2>
...
for c = 1:kc
    ...
    % <H2>GET DESIGN MATRIX FOR THIS CONTRAST OR CONDITION</H2>
    % ---------------------------------------------------------------------
    ...
    % <H2>SELECT DATA FOR THIS CONTRAST/CONDITION</H2>
    % ---------------------------------------------------------------------
    ...
    % <H2>RESAMPLE MASK SPACE TO IMAGE SPACE</H2>
    % ---------------------------------------------------------------------
    ...
    % <H2>FORMAT AND ATTACH DESIGN MATRIX</H2>
    % ---------------------------------------------------------------------
    ...
    % <H2>SANITY CHECK ON REGRESSORS, SKIP CONTRAST IF NEEDED</H2>
    % ---------------------------------------------------------------------
    ...
    % <H2>ADD COVARIATE TO .Y FIELD OF CAT_OBJ FOR MVPA IF REQUESTED</H2>
    % ---------------------------------------------------------------------
    ...
    if ~dorobfit_parcelwise
        ...
        % <H4>MAKE SURE VARIABLES ARE THE RIGHT DATA FORMAT</H4>
        ...
        if doBayes
            ...
            % <H4>CALCULATE BAYES FACTORS FROM T-MAPŜ AND ADD TO RESULTS</H4>
        ...
        % <H4>ADD CONTRASTNAMES, REGRESSORS, AND OTHER METADATA</H4>
        ...
        % <H4>PLOT MONTAGE (MASKED IF SPECIFIED IN MASKNAME_GLM)</H4>
        ...
        % <H4>KEEP RESULTS OBJECTS IN CELL ARRAY FOR SAVING</H4>
    ...
    % <H3>PARCEL-WISE</H3>    
        ...
        % <H4>PLOT PARCELWISE SPECIFIC WEIGHTS AND DIAGNOSTICS</H4>
        ...
        % <H4>PLOT MONTAGE (MASKING ALREADY DONE AS PART OF ROBFIT_PARCELWISE RUN)</H4>
    ...
    % <H2>RUN MVPA MODEL IF REQUESTED IN OPTIONS</H2>
    % ---------------------------------------------------------------------
    ...
    if domvpa_reg_cov
        ...
        for covar = 1:size(mvpa_data_objects,2)
            ...
            % <H3>RUN MODEL</H3>
                ...
                % <H4>CROSS-VALIDATION FOLD SELECTION</H4>
            ...
            % <H3>VISUALIZE UNTHRESHOLDED RESULTS</H3>
            
            fprintf('\n\n');
            printhdr('Plotting MVPA regression results');
            fprintf('\n\n');

                % <H4>PLOT OBSERVED VERSUS PREDICTED</H4>
                ...
                % <H4>PLOT MONTAGE OF UNTHRESHOLDED WEIGHTS</H4>
            ...
            % <H3>KEEP RESULTS IN CELL ARRAY FOR SAVING</H3>
